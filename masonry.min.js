(function(a,b,c)
	...
	,i=h("transform"),j=h("transitionProperty"),k=
		...
		,csstransforms3d:function()
			...
			if(a)
				...
				"+"</style>").appendTo("head"),f=b('<div id="modernizr" />').appendTo("html");
	...
	,b.Isotope.prototype=
		...
		_create:function(a)
			...
			f<g;
			f++)e=d[f],this.originalStyle[e]=c[e]||"";
		...
		,_processStyleQueue:function(a,c)
			...
			if(this._isInserting&&this.isUsingJQueryAnimation)i=function(a,b)
				...
				j=!0,k=function()
					...
					c<d;
					c++)b=m[c],typeof b=="function"&&b.call(n.element,a,n);
					l=!0
				};
		...
		,_masonryLayout:function(a)
			...
			a.each(function()
				...
				if(e===1)c._masonryPlaceBrick(a,d.colYs);
					...
					for(i=0;
					i<f;
					i++)h=d.colYs.slice(i,i+e),g[i]=Math.max.apply(Math,h);
		...
		,_masonryHorizontalLayout:function(a)
			...
			a.each(function()
				...
				if(e===1)c._masonryHorizontalPlaceBrick(a,d.rowXs);
					...
					for(i=0;
					i<f;
					i++)h=d.rowXs.slice(i,i+e),g[i]=Math.max.apply(Math,h);
		...
		,_masonryHorizontalPlaceBrick:function(a,b)
			...
			for(e=0;
			e<j;
			e++)this.masonryHorizontal.rowXs[d+e]=i
		}
	...
	b.fn.isotope=function(a,c)
		...
		if(typeof a=="string")
			...
			this.each(function()
				...
				if(!c)
					{
					w("cannot call methods on isotope prior to initialization;
...
jQuery(document).ready(function()
	...
	function reLayout()
		...
		switch(mediaQueryId)
			{
			case'large':masonryOpts=
				{
				columnWidth:$container.width()/3
			};
			break;
			case'big':masonryOpts=
				{
				columnWidth:$container.width()/3
			};
			break;
			case'medium':masonryOpts=
				{
				columnWidth:$container.width()/2
			};
			break;
			case'small':masonryOpts=
				{
				columnWidth:$container.width()/1
			};
			break;
			case'tiny':masonryOpts=
				{
				columnWidth:$container.width()/1
			};
			break
		...
		$container.isotope(
			{
			resizable:false,itemSelector:'.post',masonry:masonryOpts
		}
		).isotope('reLayout')
	}
}
...
function showpageCount(json)
	...
	" class="showpageOf"> Pages ('+(postNum-1)+')</span>'+html;
